...
await initialize({
  ...
  discordAuthUrl:
    "https://discord.com/api/oauth2/authorize?client_id=1202603223752376320&response_type=code&redirect_uri=https%3A%2F%2Fquest.gaia.cc&scope=guilds.members.read+identify",
